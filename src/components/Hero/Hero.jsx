...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] to-[#1e293b] px-6 md:px-16 text-white">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 w-full max-w-7xl">

        {/* Left Section */}
        <div className="flex-1" data-aos="fade-right">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
            Hi, I'm <span className="text-cyan-400">Mehedi</span>
          </h1>
